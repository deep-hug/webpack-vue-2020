...
class Encrypt {
    ...
    aesEncrypt(encryptData, aesKey) {
        ...
        try {
            const cipherText = CryptoJS.AES.encrypt(encryptData, secretPassphrase, {
    ...
    aesDecrypt(decryptedData, aesKey) {
        ...
        let result = '';
        try {
            const decrypted = CryptoJS.AES.decrypt(decryptedData, secretPassphrase, {
                mode: CryptoJS.mode.CBC,
                padding: CryptoJS.pad.Pkcs7,
                iv: secretPassphrase,
            });
